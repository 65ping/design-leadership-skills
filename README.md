...
A **Claude Code skill** that turns Claude into a senior advisor for design org leadership and organizational decisions. Built for **VP of Design**, **Head of Design**, **CPO**, and **CTO** navigating the real, hard calls that don't have easy answers.
